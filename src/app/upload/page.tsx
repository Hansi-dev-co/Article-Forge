  ...
  return (
    <div className="flex flex-col items-center p-4 sm:p-6 lg:p-8">
      <header className="w-full max-w-4xl mb-8 text-center">
        <h1 className="font-headline text-4xl sm:text-5xl font-bold tracking-tight text-primary">Article Editor</h1>
      ...
      <main className="w-full max-w-4xl">
        <Card className="shadow-2xl shadow-primary/10">
          <CardHeader>
            <CardTitle className="font-headline text-2xl tracking-wide">Create or Upload Article</CardTitle>
            <CardDescription>Fill in the details below or upload a file to start your masterpiece.</CardDescription>
          </CardHeader>
          <CardContent>
